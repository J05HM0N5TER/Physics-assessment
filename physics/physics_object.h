...
enum class shape : char
{
	...
	aabb,
	line,
	// Shows the total count in this enum
	shape_count
};
...
public:
	/*	\brief Updates all physics
		\param a_gravity The constant force that acts on all objects
		\param a_time_step How often the collisions will be calculated
	*/
